...
To try WooCommerce Payscript Crypto Payments Plugins on your store, simply [install it](https://wordpress.org/plugins/woocommerce-payments/#installation) and follow the prompts.
...
If you are setting up a store that will process crypto payments, have the site owner complete the WooCommerce Payments setup. This ensures that the correct business details are set on the account during [onboarding](https://woocommerce.com/document/payments/#section-3).
...
You can read our Terms of Service [here](https://payscript.io/terms-of-use/).
